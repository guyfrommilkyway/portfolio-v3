...
const LoadingScreen: React.FC<LoadingScreenProps> = (props) => {
	...
	return (
		<div
			className={`fixed top-0 right-0 bottom-0 left-0 z-[99] flex justify-center items-center w-screen h-screen bg-black transition-opacity ease-in-out delay-200 ${loading} ${removing}`}
		>
