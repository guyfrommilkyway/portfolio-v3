	...
	return (
		<ContentBox id='whatsnew'>
			...
			<ul className='list-inside list-disc text-neutral-300'>
				...
				<li>Studying Python, SQL, Django, API and database design</li>
				<li>Researching React Design Patterns, Best Practices and Clean Code</li>
				<li>
					<a
				...
				<li>
					...
					<ul className='pl-8 list-inside list-disc text-neutral-300'>
						<li>JavaScript Security Specialization</li>
